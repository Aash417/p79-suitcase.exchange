'use client'
import { Camera, ChevronDown, Maximize2, RefreshCw, Settings } from 'lucide-react';
import { useState } from 'react';

const BackpackTradingUI = () => { const [activeTab, setActiveTab] = useState('Chart'); const [activeOrderType, setActiveOrderType] = useState('Market');
            ...
            <div className="flex items-center justify-between">
               <div className="flex items-center">
                  <div className="flex items-center mr-6">
                     <span className="bg-yellow-500 text-xl rounded-full mr-2">₿</span>
                     <span className="font-medium">BTC/USDC</span>
                     <ChevronDown size={16} className="ml-1" />
                  </div>
                  <div>
                     <div className="text-green-500 text-2xl font-bold">85,028.4</div>
               ...
               <div className="flex items-center space-x-8">
                  ...
                  <div>
                     <div className="text-gray-400 text-xs">24H Volume (USDC)</div>
                     <div>6,912,708.24</div>
                  </div>
                  <div className="flex space-x-2">
                     <button className="bg-gray-800 hover:bg-gray-700 px-8 py-2 rounded">Buy</button>
                     <button className="bg-gray-800 hover:bg-gray-700 text-red-500 px-8 py-2 rounded">Sell</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div className="w-2/3 border-r border-gray-800">
               <div className="flex border-b border-gray-800">
                  ...
                  <div className="ml-auto flex items-center border-l border-gray-800 px-6">
                     <button className={`px-6 py-3 ${activeTab === 'Book' ? 'border-b-2 border-white' : 'text-gray-400'}`}>
                        Book
                     </button>
                     <button className={`px-6 py-3 ${activeTab === 'Trades' ? 'border-b-2 border-white' : 'text-gray-400'}`}>
                        Trades
                     </button>
                  </div>
               </div>
               ...
               <div className="p-3 flex items-center border-b border-gray-800">
                  ...
                  <div className="ml-auto flex space-x-4 text-gray-400">
                     <button className="p-2"><Settings size={16} /></button>
                     <button className="p-2"><Maximize2 size={16} /></button>
                     <button className="p-2"><Camera size={16} /></button>
               ...
               <div className="h-96 p-4 relative">
                  <div className="absolute top-0 left-0 p-4 text-xs">
                     ...
                     <div>
                        ...
                        <span className="text-red-500 ml-2">-152.0 (-0.18%)</span>
                     </div>
                  </div>
            ...
            <div className="w-1/3 p-4">
               ...
               <div className="space-y-4">
                  ...
                  <div className="relative">
                     ...
                     />
                     <div className="absolute right-3 top-3 text-yellow-500">₿</div>
                  </div>
                  ...
                  <div className="py-2">
                     <div className="relative w-full h-1 bg-gray-800 rounded-full">
                        ...
                        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 text-xs text-gray-400">0</div>
                        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 text-xs text-gray-400">100%</div>
                     </div>
                  </div>
                  ...
                  <div className="mt-8">
                     ...
                     {/* Sell orders (red) */}
                     {[
                        { price: '85,045.0', size: '0.03726', total: '0.28667', color: 'text-red-500' },
                        { price: '85,042.9', size: '0.03609', total: '0.24941', color: 'text-red-500' },
                        { price: '85,042.1', size: '0.00587', total: '0.21332', color: 'text-red-500' },
                        { price: '85,040.8', size: '0.03609', total: '0.20745', color: 'text-red-500' },
                        { price: '85,038.6', size: '0.03609', total: '0.17136', color: 'text-red-500' },
                        { price: '85,037.9', size: '0.05879', total: '0.13527', color: 'text-red-500' },
                        { price: '85,037.7', size: '0.07527', total: '0.07648', color: 'text-red-500' },
                        { price: '85,037.5', size: '0.00060', total: '0.00121', color: 'text-red-500' },
                        { price: '85,037.4', size: '0.00061', total: '0.00061', color: 'text-red-500' }
                     ].map((order, index) => (
                        <div key={index} className={`grid grid-cols-3 gap-4 text-sm ${order.color}`}>
                           <div>{order.price}</div>
                     ...
                     {/* Buy orders (green) */}
                     {[
                        { price: '85,036.8', size: '0.04797', total: '0.04797', color: 'text-green-500' },
                        { price: '85,034.9', size: '0.05880', total: '0.10677', color: 'text-green-500' },
                        { price: '85,033.4', size: '0.03528', total: '0.14205', color: 'text-green-500' },
                        { price: '85,032.3', size: '0.03609', total: '0.17814', color: 'text-green-500' },
                        { price: '85,030.2', size: '0.03609', total: '0.21423', color: 'text-green-500' },
                        { price: '85,028.1', size: '0.03609', total: '0.25032', color: 'text-green-500' },
                        { price: '85,026.0', size: '0.03609', total: '0.28641', color: 'text-green-500' }
                     ].map((order, index) => (
                        <div key={index} className={`grid grid-cols-3 gap-4 text-sm ${order.color}`}>
                           <div>{order.price}</div>
                           <div className="text-center">{order.size}</div>
