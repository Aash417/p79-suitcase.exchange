         ...
         <CardContent className="">
            <div className="space-y-3">
               <Select
                  ...
                  defaultValue="USDC"
               >
                  <SelectTrigger className="w-full h-10 px-3 py-2 rounded-lg bg-[#1C1D21] border border-[#2C2D33] text-sm text-gray-100 focus:outline-none focus:ring-1 focus:ring-[#3B3C42] hover:bg-[#2C2D33]/50 transition-colors">
               ...
               <Button
                  className="w-full cursor-pointer bg-white/40"
                  type="submit"
