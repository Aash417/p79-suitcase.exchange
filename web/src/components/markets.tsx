      ...
      <div className="w-full bg-black text-white p-4 rounded-lg">
         ...
         <div className="mb-4">
            <div className="flex space-x-4">
               <span className="font-semibold border-b-2 border-white pb-2">Spot</span>
               <span className="text-gray-400">Futures</span>
         ...
         <Table className='bg-[#14151b]'>
            ...
            <TableBody>
               {cryptoData.map((crypto) => (
                  ...
                  <TableRow className="border-b border-gray-800" key={crypto.name}>
                     <TableCell>
                        <Link href={`/trade/${crypto.symbol.replace('/','_')}`} >
                     ...
                     <TableCell className={`text-right ${crypto.color}`}>{crypto.change}</TableCell>
                     <TableCell className="text-right">{crypto.trend}</TableCell>
                  </TableRow>
               ))}
            </TableBody>
         </Table>
